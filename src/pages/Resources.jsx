...
const programs = [
...

  {
    ...
    title: {
      en: 'ACLS: Advanced Cardiovascular Life Support',
    ...
    description: {
      en: 'Review ACLS algorithms, airway management, cardiac arrest, acute coronary syndromes, stroke, pharmacology, and high-performance team resources.',
      es: 'Revisa algoritmos ACLS, manejo de la vía aérea, paro cardíaco, síndromes coronarios agudos, accidente cerebrovascular, farmacología y recursos para equipos de alto rendimiento.',
    },
